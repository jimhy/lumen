...
| LLM CLI input | Supported Claude Code, Codex, and Kimi CLIs keep Lumen's smart composer by default; classic passthrough switches to native per-key input with `/` command menus and clipboard-image paste shortcuts intact. |
